...
if __name__ == "__main__":
    ...
    '''
    Usage:
        python build_vocab.py --corpus-data "./datasets/drug_qa_sep_surround_answer0.sp/*" --langs ar_AR,cs_CZ,de_DE,en_XX,es_XX,et_EE,fi_FI,fr_XX,gu_IN,hi_IN,it_IT,ja_XX,kk_KZ,ko_KR,lt_LT,lv_LV,my_MM,ne_NP,nl_XX,ro_RO,ru_RU,si_LK,tr_TR,vi_VN,zh_CN --output ./models/finetune/dict.txt
    '''
